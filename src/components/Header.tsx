  ...
  return <header className="sticky top-0 z-50 w-full">
      ...
      {mobileMenuOpen && <div className="md:hidden glassmorphism absolute top-full left-0 w-full py-4 px-6 shadow-lg z-50">
          <nav className="flex flex-col space-y-3">
            ...
            <Link to="/about" className="font-medium py-2 hover:text-gold transition-colors" onClick={() => setMobileMenuOpen(false)}>
              Sobre
            </Link>
            <Link to="/contact" className="font-medium py-2 hover:text-gold transition-colors" onClick={() => setMobileMenuOpen(false)}>
              Contato
            </Link>
